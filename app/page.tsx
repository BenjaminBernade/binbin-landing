      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-8 md:px-10 lg:px-16">
          <header className="flex items-center justify-between">
            <a href="#top" className="text-sm uppercase tracking-[0.4em] text-white/72 transition hover:text-white">
              BiNBiN
            </a>
          ...
          <div id="top" className="grid flex-1 items-center gap-16 py-16 md:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:py-24">
            <div className="animate-[fadeIn_0.9s_ease-out]">
              ...
              <h1 className="text-6xl font-semibold tracking-[-0.06em] text-white md:text-8xl lg:text-[7.2rem]">
                BiNBiN
              </h1>

              <p className="mt-6 max-w-2xl text-xl italic text-white/82 md:text-2xl">
                House music with groove, soul and intention
              </p>
            ...
            <div className="relative animate-[fadeIn_1.2s_ease-out]">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
                <img
                  src="/dj.jpg"
                  alt="BiNBiN DJ"
                  className="h-full min-h-[520px] w-full object-cover grayscale contrast-125 transition duration-700 hover:scale-[1.02]"
                />
  ...
  <div className="mx-auto max-w-5xl px-6 md:px-10">
    ...
    <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center justify-center rounded-full border border-white/15 px-5 py-3 text-sm font-medium text-white transition duration-300 hover:bg-white/8"
      >
        Visit Instagram
      </a>
    </div>

    <div className="mt-10 overflow-hidden rounded-[1.5rem] border border-white/10 bg-black/20 p-3 backdrop-blur-sm">
      <iframe
        width="100%"
        height="166"
        scrolling="no"
